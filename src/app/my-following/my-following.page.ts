...
@Component({
  ...
  templateUrl: './my-following.page.html',
  styleUrls: ['./my-following.page.scss'],
})
export class MyFollowingPage implements OnInit {
  ...
  constructor(public router: Router, public toastController: ToastController,
              public nav: NavController, private http: HttpClient, public storage: Storage,
    ...
    Promise.all([
      ...
      const requestData = {
        ...
        params: {
          ...
          properties: ['CollectedVisitorId.Visitor.___all'],
