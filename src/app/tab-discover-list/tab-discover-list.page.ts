...
import { ShopHomePage } from '../shop-home/shop-home.page';
import { NavController } from '@ionic/angular';
import { Location } from '@angular/common';
@Component({
  selector: 'app-tab-discover-list',
  templateUrl: './tab-discover-list.page.html',
  styleUrls: ['./tab-discover-list.page.scss'],
})
export class TabDiscoverListPage implements OnInit {
  public categoryData = [];
  ...
  public getCategoryDetailData(typeNumber: number) {
    if (typeNumber == 102) {
  ...
  categoryLeftClick (index: number) {
